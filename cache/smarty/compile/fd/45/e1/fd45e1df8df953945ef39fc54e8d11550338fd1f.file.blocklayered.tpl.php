<?php /* Smarty version Smarty-3.1.19, created on 2017-11-03 22:20:59
         compiled from "C:\xampp\htdocs\Presta16\themes\jms_delphinus\modules\blocklayered\blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107294042959fcddbb251cb2-46586235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd45e1df8df953945ef39fc54e8d11550338fd1f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Presta16\\themes\\jms_delphinus\\modules\\blocklayered\\blocklayered.tpl',
      1 => 1509733217,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '107294042959fcddbb251cb2-46586235',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59fcddbb336d10_56676124',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59fcddbb336d10_56676124')) {function content_59fcddbb336d10_56676124($_smarty_tpl) {?>
...
<?php $_tmp2=ob_get_clean();?><?php echo smartyTranslate(array('s'=>$_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS(sprintf('%1$s: %2$s - %3$s',$_smarty_tpl->tpl_vars['filter']->value['name'],$_tmp1,$_tmp2),'html','UTF-8'),'mod'=>'blocklayered'),$_smarty_tpl);?>

													<?php } else { ?>
														<?php echo smartyTranslate(array('s'=>$_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS(sprintf('%1$s: %2$s %4$s - %3$s %4$s',$_smarty_tpl->tpl_vars['filter']->value['name'],$_smarty_tpl->tpl_vars['filter']->value['values'][0],$_smarty_tpl->tpl_vars['filter']->value['values'][1],$_smarty_tpl->tpl_vars['filter']->value['unit']),'html','UTF-8'),'mod'=>'blocklayered'),$_smarty_tpl);?>
...
" style="display: none;">
                        ...
                        <div class="layered_subtitle_heading">
                            <h2 class="title_block">
								<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['filter']->value['name'],'html','UTF-8');?>
...
"<?php }?><?php }?>>
												...
												<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['value']->value['name'],'html','UTF-8');?>
...
"<?php }?>><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['value']->value['name'],'html','UTF-8');?>
<?php if ($_smarty_tpl->tpl_vars['layered_show_qties']->value) {?><span> (<?php echo $_smarty_tpl->tpl_vars['value']->value['nbr'];?>
)</span><?php }?></a>
												<?php }?>
											</label>
