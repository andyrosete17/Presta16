<?php /* Smarty version Smarty-3.1.19, created on 2017-11-03 19:33:48
         compiled from "C:\xampp\htdocs\Presta16\admin573yqroyx\themes\default\template\controllers\modules_positions\list_modules.tpl" */ ?>
<?php /*%%SmartyHeaderCode:180030016059fcb68c7a25d9-22280831%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '27f48d2f015ce2e6c1564918ef1804b135684ba9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Presta16\\admin573yqroyx\\themes\\default\\template\\controllers\\modules_positions\\list_modules.tpl',
      1 => 1504515462,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180030016059fcb68c7a25d9-22280831',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59fcb68c819f67_20079695',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59fcb68c819f67_20079695')) {function content_59fcb68c819f67_20079695($_smarty_tpl) {?>
...
"<?php if ($_smarty_tpl->tpl_vars['display_key']->value==$_smarty_tpl->tpl_vars['module']->value->id) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['module']->value->displayName,'html','UTF-8');?>
</option>
								<?php } ?>
							</select>
						</div>
			...
			<div id="modulePosition">
				<form method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['url_submit']->value,'html','UTF-8');?>
" >
...
">
									...
									<div class="btn-group-vertical">
										<a class="btn btn-default btn-xs" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['current']->value,'html','UTF-8');?>
...
&amp;direction=0&amp;token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['token']->value,'html','UTF-8');?>
...
&amp;id_module=<?php echo intval($_smarty_tpl->tpl_vars['module']->value['instance']->id);?>
&amp;id_hook=<?php echo intval($_smarty_tpl->tpl_vars['hook']->value['id_hook']);?>
&amp;direction=1&amp;token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['token']->value,'html','UTF-8');?>
&amp;changePosition#<?php echo $_smarty_tpl->tpl_vars['hook']->value['name'];?>
">
...
"></div> -->
									<div class="btn-group">
										<a class="btn btn-default" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['current']->value,'html','UTF-8');?>
&amp;id_module=<?php echo intval($_smarty_tpl->tpl_vars['module']->value['instance']->id);?>
...
<?php }?>&amp;token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['token']->value,'html','UTF-8');?>
">
										...
										<ul class="dropdown-menu">
											<li>
												<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['current']->value,'html','UTF-8');?>
&amp;id_module=<?php echo intval($_smarty_tpl->tpl_vars['module']->value['instance']->id);?>
&amp;id_hook=<?php echo $_smarty_tpl->tpl_vars['hook']->value['id_hook'];?>
		...
		<div class="panel">
			...
			<?php } else { ?>
				<p><?php echo smartyTranslate(array('s'=>'Click here to be redirected to the front office of your shop where you can move and delete modules directly.'),$_smarty_tpl);?>
					...
					<a class="btn btn-default _blank" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['url_live_edit']->value,'html','UTF-8');?>
">
						<i class="icon-edit"></i>
