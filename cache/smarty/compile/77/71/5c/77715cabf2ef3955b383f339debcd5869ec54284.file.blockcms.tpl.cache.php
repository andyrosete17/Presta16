<?php /* Smarty version Smarty-3.1.19, created on 2017-11-03 19:09:20
         compiled from "C:\xampp\htdocs\Presta16\themes\default-bootstrap\modules\blockcms\blockcms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:38685321059fcb0d0cffc87-60136577%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '77715cabf2ef3955b383f339debcd5869ec54284' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Presta16\\themes\\default-bootstrap\\modules\\blockcms\\blockcms.tpl',
      1 => 1504515462,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38685321059fcb0d0cffc87-60136577',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59fcb0d0d32766_05441140',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59fcb0d0d32766_05441140')) {function content_59fcb0d0d32766_05441140($_smarty_tpl) {?>
	...
	<section class="footer-block col-xs-12 col-sm-2" id="block_various_links_footer">
		...
		<ul class="toggle-footer">
			<?php if (isset($_smarty_tpl->tpl_vars['show_price_drop']->value)&&$_smarty_tpl->tpl_vars['show_price_drop']->value&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
				<li class="item">
					<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('prices-drop'),'html','UTF-8');?>
...
">
			...
			<li class="item">
				<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('new-products'),'html','UTF-8');?>
...
">
			...
			<?php if (isset($_smarty_tpl->tpl_vars['show_best_sales']->value)&&$_smarty_tpl->tpl_vars['show_best_sales']->value&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
				<li class="item">
					<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('best-sales'),'html','UTF-8');?>
...
?>
				<?php if ($_smarty_tpl->tpl_vars['cmslink']->value['meta_title']!='') {?>
					<li class="item">
						<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['cmslink']->value['link'],'html','UTF-8');?>
...
">
	...
	<section class="bottom-footer col-xs-12">
		<div>
			<?php echo '/*%%SmartyNocache:38685321059fcb0d0cffc87-60136577%%*/<?php echo smartyTranslate(array(\'s\'=>\'[1] %3$s %2$s - Ecommerce software by %1$s [/1]\',\'mod\'=>\'blockcms\',\'sprintf\'=>array(\'PrestaShop™\',date(\'Y\'),\'©\'),\'tags\'=>array(\'<a class="_blank" href="http://www.prestashop.com">\')),$_smarty_tpl);?>
/*/%%SmartyNocache:38685321059fcb0d0cffc87-60136577%%*/';?>
